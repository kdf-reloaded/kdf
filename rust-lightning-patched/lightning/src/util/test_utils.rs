...
use util::enforcing_trait_impls::{EnforcementState, EnforcingSigner};
use util::events;
...
use chain::keysinterface::{InMemorySigner, KeyMaterial, Recipient};
...
impl keysinterface::KeysInterface for OnlyReadsKeysInterface {
    ...
    fn read_chan_signer(&self, mut reader: &[u8]) -> Result<Self::Signer, msgs::DecodeError> {
        ...
        Ok(EnforcingSigner::new_with_revoked(inner, state, false))
    }
    fn sign_invoice(
        &self,
        _hrp_bytes: &[u8],
...
pub struct TestChainMonitor<'a> {
    ...
    pub chain_monitor: chainmonitor::ChainMonitor<
        ...
        &'a TestFeeEstimator,
        &'a TestLogger,
        &'a chainmonitor::Persist<EnforcingSigner>,
    >,
...
impl<'a> TestChainMonitor<'a> {
    pub fn new(
        ...
        persister: &'a chainmonitor::Persist<EnforcingSigner>,
...
impl<'a> chain::Watch<EnforcingSigner> for TestChainMonitor<'a> {
    fn watch_channel(
        ...
        monitor: channelmonitor::ChannelMonitor<EnforcingSigner>,
    ...
    fn update_channel(
        ...
        assert!(channelmonitor::ChannelMonitorUpdate::read(&mut io::Cursor::new(&w.0)).unwrap() == update);

        self.monitor_updates
            .lock()
            .unwrap()
            .entry(funding_txo.to_channel_id())
            .or_insert(Vec::new())
            .push(update.clone());
        ...
        self.latest_monitor_update_id.lock().unwrap().insert(
            ...
            (
                funding_txo,
                update.update_id,
                MonitorUpdateId::from_monitor_update(&update),
            ),
        );
