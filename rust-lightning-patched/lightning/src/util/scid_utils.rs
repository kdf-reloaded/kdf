...
pub(crate) mod fake_scid {
    ...
    impl Namespace {
        ...
        pub(crate) fn get_fake_scid<Signer: Sign, K: Deref>(
            &self,
    ...
    mod tests {
        ...
        use util::scid_utils::fake_scid::{
            is_valid_phantom, segwit_activation_height, Namespace, MAINNET_SEGWIT_ACTIVATION_HEIGHT, MAX_NAMESPACES,
            MAX_TX_INDEX, NAMESPACE_ID_BITMASK, TEST_SEGWIT_ACTIVATION_HEIGHT,
        };
        use util::test_utils;
