...
impl Condvar {
    ...
    pub fn wait_timeout<'a, T>(
        ...
        self.inner
            .wait_timeout(guard.into_inner(), dur)
            .map(|(lock, _)| (MutexGuard { mutex, lock }, ()))
            .map_err(|_| ())
    }
...
impl PartialEq for LockMetadata {
    fn eq(&self, o: &LockMetadata) -> bool {
        self.lock_idx == o.lock_idx
    }
}
impl Eq for LockMetadata {}
impl std::hash::Hash for LockMetadata {
    fn hash<H: std::hash::Hasher>(&self, hasher: &mut H) {
        hasher.write_u64(self.lock_idx);
    }
}
...
impl LockMetadata {
    ...
    fn pre_lock(this: &Arc<LockMetadata>) {
        Self::_pre_lock(this, false);
    }
    fn pre_read_lock(this: &Arc<LockMetadata>) -> bool {
        Self::_pre_lock(this, true)
    }
